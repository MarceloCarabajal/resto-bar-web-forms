        ...
        <div class="col-md-6 col-lg-3">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <a class="btn btn-outline-primary" href="InsumosLista.aspx">Ver insumos</a>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-lg-3">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <a class="btn btn-outline-primary" href="MesasPedidos.aspx">Ir a mesas</a>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-lg-3">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <a class="btn btn-outline-primary" href="Reportes.aspx">Ver reportes</a>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-lg-3">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <a class="btn btn-outline-primary" href="Login.aspx">Ingresar</a>
                </div>
            </div>
        </div>
